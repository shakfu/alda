-- Solarized Light Theme for Loki Editor
...
return function()
    loki.set_theme({
        -- Base types (0-8)
        normal    = {r=101, g=123, b=131},  -- #657b83 base00
        nonprint  = {r=147, g=161, b=161},  -- #93a1a1 base1
        comment   = {r=147, g=161, b=161},  -- #93a1a1 base1
        mlcomment = {r=147, g=161, b=161},  -- #93a1a1 base1
        ...
        -- Variables
        variable          = {r=101, g=123, b=131},  -- #657b83 base00
        variable_builtin  = {r=38,  g=139, b=210},  -- #268bd2 blue
        variable_parameter= {r=101, g=123, b=131},  -- #657b83 base00
        variable_field    = {r=101, g=123, b=131},  -- #657b83 base00
        variable_property = {r=101, g=123, b=131},  -- #657b83 base00
        ...
        -- Comments
        comment_doc       = {r=147, g=161, b=161},  -- #93a1a1 base1
        ...
        punctuation       = {r=101, g=123, b=131},  -- #657b83 base00
        punctuation_bracket   = {r=101, g=123, b=131},  -- #657b83 base00
        punctuation_delimiter = {r=147, g=161, b=161},  -- #93a1a1 base1
        ...
        tag_attribute     = {r=101, g=123, b=131},  -- #657b83 base00
    ...
    if loki.status then
        loki.status("Solarized Light theme loaded")
    end
end
