/* scheme.c -- Tree-sitter based Scheme syntax highlighting
 *
 * Uses tree-sitter to parse Scheme code and highlight it.
 */
...
/* Scheme highlighting query - simplified for REPL use */
