...
from CHANGELOG.md. Headings are compared with `==` against a Python
string, so the dot-in-version-as-regex-metachar pitfall does not apply.
"""
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    parser.add_argument(
        "version",
        help='Release version, e.g. "0.1.7". The script first looks for '
